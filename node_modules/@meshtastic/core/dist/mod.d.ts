...
//#endregion
//#region src/utils/eventSystem.d.js
declare class EventSystem {
   ...
   */
  readonly onClientNotificationPacket: SimpleEventDispatcher<Protobuf.Mesh.ClientNotification>;
  /**
...
//#endregion
//#region src/utils/transform/fromDevice.d.js
declare const fromDeviceStream: () => TransformStream<Uint8Array, DeviceOutput>;
//#endregion
//#region src/utils/transform/toDevice.d.js
/**
...
declare class MeshDevice {
   ...
   */
  handleMeshPacket(meshPacket: Protobuf.Mesh.MeshPacket): void;
